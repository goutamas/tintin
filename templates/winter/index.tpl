				...
				<div class="block" id="projecthead" style = "{$projectstyle}">{*Add Project*}
					...
					<table id = "desktopprojects" cellpadding="0" cellspacing="0" border="0">
						<thead>
							<tr>
								<th class="a"></th>
								<th class="b" style="width:290px; cursor:pointer;" onclick = "sortBlock('desktopprojects','');">{#project#}</th>
								<th class="c" style="width:160px; cursor:pointer;">{#done#}</th>
								<th class="cf" style="width:50px">{#priority#}</th>
								<th class="d"  style="width:20px; cursor:pointer;" onclick = "sortBlock('desktopprojects','daysleft');">{#daysleft#}</th>
								<th class="tools"></th>
							</tr>
						</thead>
				...
				<div class="block" id="taskhead" style = "{$taskstyle}">
					...
					<table id = "desktoptasks" cellpadding="0" cellspacing="0" border="0">
						<thead>
							<tr>
								<th class="a"></th>
								<th class="b" style="cursor:pointer; width:240px;" onclick = "sortBlock('desktoptasks','');">{#task#}</th>
								<th class="c" style="cursor:pointer; width:240px;" onclick = "sortBlock('desktoptasks','project');">{#project#}</th>
								<th class="cf" style="width:50px">{#priority#}</th>
								<th class="d" style="width:20px; cursor:pointer;text-align:right" onclick = "sortBlock('desktoptasks','daysleft');">{#daysleft#}&nbsp;&nbsp;</th>
								<th class="tools"></th>
							</tr>
						</thead>
								...
								<tr {if $tasks[task].daysleft < 0} class="marker-late"{elseif $tasks[task].daysleft == 0} class="marker-today"{/if}>
									...
									<td>
										<div class="toggle-in">
											...
											{if $tasks[task].title != ""}
												{$tasks[task].title|truncate:40:"...":true}
											{else}
												{$tasks[task].text|truncate:40:"...":true}
											{/if}
											</a>
										</div>
									</td>
					...
					<table id = "desktopmessages" cellpadding="0" cellspacing="0" border="0">
						...
						<thead>
							<tr>
								...
								<th class="de">{#by#}</th>
								<th class="e" style="width:110px;">{#on#}</th>
								<th class="tools"></th>
							</tr>
						</thead>
									...
									<td>
										...
										<span class="acc-toggle" onclick="javascript:accord_msgs.activate($$('#activityhead .accordion_toggle')[{$smarty.section.message.index}]);toggleAccordeon('activityhead',this);"></span>
											<a href="managemessage.php?action=showmessage&amp;mid={$messages[message].ID}&amp;id={$messages[message].project}" title="{$messages[message].title}">
												{$messages[message].title|truncate:33:"...":true}
											</a>
								</div>
							</td>
