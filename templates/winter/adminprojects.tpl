	...
	<div id="content-left-in">
		<div class="projects">
			...
			<div class="infowin_left" style = "display:none;" id = "systemmsg">
				...
				{elseif $mode == "tpladded"}
					<span class="info_in_green"><img src="templates/standard/images/symbols/projects.png" alt=""/>{#templatewasadded#}</span>
				{/if}
			</div>
					...
					<table id = "adminprojects" cellpadding="0" cellspacing="0" border="0">
						<thead>
							<tr>
								...
								<th class="c" style="width:166px">{#done#}</th>
								<th class="cf" style="width:50px">{#priority#}</th>
								<th class="d" style="width:20px">{#daysleft#}</th>
								<th class="tools"></th>
							</tr>
						</thead>
					...
					<div id="doneblock" class="doneblock" style="display: none;">
						...
						<table class="second-thead" cellpadding="0" cellspacing="0" border="0" onclick="blindtoggle('doneblock');toggleClass('donebutn','butn_link_active','butn_link');toggleClass('toggle-done','acc-toggle','acc-toggle-active');">
							<tr>
								...
								<td class="c" style="width:166px"></td>
								...
								{section name=clopro loop=$clopros}
									...
									{/if}
										<tr>
											...
											<td class="c" style="width:166px"><div class="statusbar_b"><div class="complete" id = "completed" style="width:{$myprojects[project].done}%;"></div></div><span>{$myprojects[project].done}%</span></td>
											<td class="cf" style="width:50px">{$clopros[clopro].priority}</td>
											<td class="days" style="width:20px">{$clopros[clopro].daysleft}</td>
											<td class="tools">
												{if $userpermissions.projects.edit}
